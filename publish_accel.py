...
def SpatialData(e):
    ...
    pub = rospy.Publisher('accel', Vector3)
    vector3 = Vector3()
    vector3.x = spatialData.Acceleration[0]
    vector3.y = spatialData.Acceleration[1]
    vector3.z = spatialData.Acceleration[2]
    pub.publish(vector3)
    br = tf.TransformBroadcaster()
    br.sendTransform((vector3.x, vector3.y, vector3.z), (1, 1, 1, 1), rospy.Time.now(), "/accela", "/accelb")
...
try:
    ...
    print ("max is" + str(spatial.getDataRateMax()))
    spatial.setDataRate(200)
    DisplayDeviceInfo()
